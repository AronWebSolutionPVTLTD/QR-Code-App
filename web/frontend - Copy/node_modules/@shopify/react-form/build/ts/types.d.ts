...
export interface FormWithDynamicListsInput<T extends FieldBag, D extends DynamicListBag> {
    fields: T;
    dynamicLists: D;
    onSubmit?: SubmitHandler<FormMapping<T, 'value'> & FormMapping<DynamicListMapping<D>, 'value'>>;
    makeCleanAfterSubmit?: boolean;
}
...
export interface FormWithDynamicLists<T extends FieldBag, D extends DynamicListBag> extends Form<T> {
    dynamicLists: D;
}
