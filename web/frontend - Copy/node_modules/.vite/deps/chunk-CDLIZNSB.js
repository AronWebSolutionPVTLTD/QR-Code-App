...
var require_web_vitals_umd = __commonJS({
  "node_modules/web-vitals/dist/web-vitals.umd.cjs"(exports, module) {
    !function(e, n) {
      ...
      "use strict";
      var n, t, r, i, a, o = -1, c = function(e2) {
        ...
        var t2 = u(), r2 = "navigate";
        return o >= 0 ? r2 = "back-forward-cache" : t2 && (r2 = document.prerendering || f() > 0 ? "prerender" : t2.type.replace(/_/g, "-")), { name: e2, value: void 0 === n2 ? -1 : n2, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: r2 };
      }, d = function(e2, n2, t2) {
        try {
        ...
        var t2 = function t3(r2) {
          "pagehide" !== r2.type && "hidden" !== document.visibilityState || (e2(r2), n2 && (removeEventListener("visibilitychange", t3, true), removeEventListener("pagehide", t3, true)));
        };
        addEventListener("visibilitychange", t2, true), addEventListener("pagehide", t2, true);
      }, p = function(e2, n2, t2, r2) {
        var i2, a2;
        return function(o2) {
          n2.value >= 0 && (o2 || r2) && ((a2 = n2.value - (i2 || 0)) || void 0 === i2) && (i2 = n2.value, n2.delta = a2, n2.rating = function(e3, n3) {
        ...
        n2 = n2 || {};
        var t2, r2 = [1800, 3e3], i2 = g(), a2 = s("FCP"), o2 = function(e3) {
          e3.forEach(function(e4) {
            "first-contentful-paint" === e4.name && (l2 && l2.disconnect(), e4.startTime < i2.firstHiddenTime && (a2.value = Math.max(e4.startTime - f(), 0), a2.entries.push(e4), t2(true)));
          });
        }, u2 = window.performance && window.performance.getEntriesByName && window.performance.getEntriesByName("first-contentful-paint")[0], l2 = u2 ? null : d("paint", o2);
        (u2 || l2) && (t2 = p(e2, a2, r2, n2.reportAllChanges), u2 && o2([u2]), c(function(i3) {
          a2 = s("FCP"), t2 = p(e2, a2, r2, n2.reportAllChanges), requestAnimationFrame(function() {
            requestAnimationFrame(function() {
              a2.value = performance.now() - i3.timeStamp, t2(true);
            });
          });
        }));
      }, T = false, E = -1, C = function(e2, n2) {
        n2 = n2 || {};
        var t2 = [0.1, 0.25];
        T || (y(function(e3) {
          E = e3.value;
        ...
        var r2, i2 = function(n3) {
          E > -1 && e2(n3);
        }, a2 = s("CLS", 0), o2 = 0, u2 = [], f2 = function(e3) {
          e3.forEach(function(e4) {
            if (!e4.hadRecentInput) {
              var n3 = u2[0], t3 = u2[u2.length - 1];
              o2 && e4.startTime - t3.startTime < 1e3 && e4.startTime - n3.startTime < 5e3 ? (o2 += e4.value, u2.push(e4)) : (o2 = e4.value, u2 = [e4]), o2 > a2.value && (a2.value = o2, a2.entries = u2, r2());
            }
          });
        }, v2 = d("layout-shift", f2);
        v2 && (r2 = p(i2, a2, t2, n2.reportAllChanges), l(function() {
          f2(v2.takeRecords()), r2(true);
        }), c(function() {
          o2 = 0, E = -1, a2 = s("CLS", 0), r2 = p(i2, a2, t2, n2.reportAllChanges);
        }));
      }, w = { passive: true, capture: true }, L = new Date(), b = function(e2, i2) {
        n || (n = i2, t = e2, r = new Date(), F(removeEventListener), S());
      }, S = function() {
        if (t >= 0 && t < r - L) {
        ...
        r2 = r2 || {};
        var a2, o2 = [100, 300], u2 = g(), f2 = s("FID"), v2 = function(e3) {
          e3.startTime < u2.firstHiddenTime && (f2.value = e3.processingStart - e3.startTime, f2.entries.push(e3), a2(true));
        }, m2 = function(e3) {
          e3.forEach(v2);
        }, h2 = d("first-input", m2);
        a2 = p(e2, f2, o2, r2.reportAllChanges), h2 && l(function() {
          m2(h2.takeRecords()), h2.disconnect();
        }, true), h2 && c(function() {
          var c2;
          f2 = s("FID"), a2 = p(e2, f2, o2, r2.reportAllChanges), i = [], t = -1, n = null, F(addEventListener), c2 = v2, i.push(c2), S();
        });
      }, P = 0, M = 1 / 0, k = 0, x = function(e2) {
        e2.forEach(function(e3) {
          e3.interactionId && (M = Math.min(M, e3.interactionId), k = Math.max(k, e3.interactionId), P = k ? (k - M) / 7 + 1 : 0);
        });
      }, B = function() {
        return a ? P : performance.interactionCount || 0;
      }, D = function() {
        "interactionCount" in performance || a || (a = d("event", x, { type: "event", buffered: true, durationThreshold: 0 }));
      }, N = 0, R = function() {
        return B() - N;
      }, q = [], H = {}, O = function(e2) {
        var n2 = q[q.length - 1], t2 = H[e2.interactionId];
        if (t2 || q.length < 10 || e2.duration > n2.latency) {
          if (t2)
            t2.entries.push(e2), t2.latency = Math.max(t2.latency, e2.duration);
          else {
            var r2 = { id: e2.interactionId, latency: e2.duration, entries: [e2] };
            H[r2.id] = r2, q.push(r2);
          }
          q.sort(function(e3, n3) {
            return n3.latency - e3.latency;
          }), q.splice(10).forEach(function(e3) {
            delete H[e3.id];
          });
        }
      }, j = function(e2, n2) {
        ...
        var t2 = [200, 500];
        D();
        var r2, i2 = s("INP"), a2 = function(e3) {
          e3.forEach(function(e4) {
            (e4.interactionId && O(e4), "first-input" === e4.entryType) && (!q.some(function(n4) {
              return n4.entries.some(function(n5) {
                return e4.duration === n5.duration && e4.startTime === n5.startTime;
              });
            }) && O(e4));
          });
          var n3, t3 = (n3 = Math.min(q.length - 1, Math.floor(R() / 50)), q[n3]);
          t3 && t3.latency !== i2.value && (i2.value = t3.latency, i2.entries = t3.entries, r2());
        }, o2 = d("event", a2, { durationThreshold: n2.durationThreshold || 40 });
        r2 = p(e2, i2, t2, n2.reportAllChanges), o2 && (o2.observe({ type: "first-input", buffered: true }), l(function() {
          a2(o2.takeRecords()), i2.value < 0 && R() > 0 && (i2.value = 0, i2.entries = []), r2(true);
        }), c(function() {
          q = [], N = B(), i2 = s("INP"), r2 = p(e2, i2, t2, n2.reportAllChanges);
        }));
      }, _ = {}, V = function(e2, n2) {
        n2 = n2 || {};
        var t2, r2 = [2500, 4e3], i2 = g(), a2 = s("LCP"), o2 = function(e3) {
          var n3 = e3[e3.length - 1];
          if (n3) {
            var r3 = Math.max(n3.startTime - f(), 0);
            r3 < i2.firstHiddenTime && (a2.value = r3, a2.entries = [n3], t2());
          }
        }, u2 = d("largest-contentful-paint", o2);
        if (u2) {
          t2 = p(e2, a2, r2, n2.reportAllChanges);
          var v2 = function() {
            _[a2.id] || (o2(u2.takeRecords()), u2.disconnect(), _[a2.id] = true, t2(true));
          };
          ["keydown", "click"].forEach(function(e3) {
            addEventListener(e3, v2, { once: true, capture: true });
          }), l(v2, true), c(function(i3) {
            a2 = s("LCP"), t2 = p(e2, a2, r2, n2.reportAllChanges), requestAnimationFrame(function() {
              requestAnimationFrame(function() {
                a2.value = performance.now() - i3.timeStamp, _[a2.id] = true, t2(true);
              });
            });
          });
        }
        ...
        n2 = n2 || {};
        var t2 = [800, 1800], r2 = s("TTFB"), i2 = p(e2, r2, t2, n2.reportAllChanges);
        z(function() {
          var a2 = u();
          if (a2) {
            if (r2.value = Math.max(a2.responseStart - f(), 0), r2.value < 0 || r2.value > performance.now())
              return;
            r2.entries = [a2], i2(true), c(function() {
              r2 = s("TTFB", 0), (i2 = p(e2, r2, t2, n2.reportAllChanges))(true);
            });
          }
        });
      };
      e.getCLS = C, e.getFCP = y, e.getFID = I, e.getINP = j, e.getLCP = V, e.getTTFB = G, e.onCLS = C, e.onFCP = y, e.onFID = I, e.onINP = j, e.onLCP = V, e.onTTFB = G, Object.defineProperty(e, "__esModule", { value: true });
    });
  }
});
...
var require_actions3 = __commonJS({
  "node_modules/@shopify/app-bridge/actions/WebVitals/actions.js"(exports) {
    ...
    function initializeWebVitals(app) {
      ...
      var isMobile = typeof navigator !== "undefined" && (navigator.userAgent.indexOf("Shopify Mobile") >= 0 || navigator.userAgent.indexOf("Shopify POS") >= 0 || navigator.userAgent.indexOf("Shopify Ping") >= 0);
...
//# sourceMappingURL=chunk-CDLIZNSB.js.map
