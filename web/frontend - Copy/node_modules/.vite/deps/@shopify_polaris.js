...
function CustomProperties(props) {
  ...
  return import_react5.default.createElement(Component9, {
...
function getMediaConditions(breakpoints2) {
  ...
  return Object.fromEntries(breakpointEntries.map(function(entry, index) {
    var _ref5 = entry, _ref6 = _slicedToArray(_ref5, 2), breakpointsTokenName = _ref6[0], breakpoint = _ref6[1].value;
    var upMediaCondition = getUpMediaCondition(breakpoint);
    var downMediaCondition = getDownMediaCondition(breakpoint);
    var onlyMediaCondition = index === lastBreakpointIndex ? upMediaCondition : "".concat(upMediaCondition, " and ").concat(getDownMediaCondition(
...
var UniqueIdFactoryContext = (0, import_react11.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/link/context.js
var import_react12 = __toESM(require_react());
var LinkContext = (0, import_react12.createContext)(void 0);
...
var MediaQueryContext = (0, import_react13.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/components/EventListener/EventListener.js
var import_react14 = __toESM(require_react());
var EventListener = class extends import_react14.PureComponent {
  componentDidMount() {
    this.attachListener();
  }
  componentDidUpdate({
...
var MediaQueryProvider = function MediaQueryProvider2({
  ...
  const [isNavigationCollapsed, setIsNavigationCollapsed] = (0, import_react15.useState)(navigationBarCollapsed().matches);
  ...
  return import_react15.default.createElement(MediaQueryContext.Provider, {
    value: context
  }, import_react15.default.createElement(EventListener, {
    event: "resize",
...
function PortalsManager({
  ...
  const [portalContainerElement, setPortalContainerElement] = (0, import_react18.useState)(null);
...
// node_modules/@shopify/polaris/build/esm/components/AppProvider/AppProvider.js
var AppProvider = class extends import_react21.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return import_react21.default.createElement(FeaturesContext.Provider, {
      value: features
    }, import_react21.default.createElement(I18nContext.Provider, {
      value: intl
    }, import_react21.default.createElement(ScrollLockManagerContext.Provider, {
      value: this.scrollLockManager
    }, import_react21.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react21.default.createElement(UniqueIdFactoryContext.Provider, {
      value: this.uniqueIdFactory
    }, import_react21.default.createElement(LinkContext.Provider, {
      value: link
    }, import_react21.default.createElement(CustomProperties, {
      colorScheme
    }, import_react21.default.createElement(MediaQueryProvider, null, import_react21.default.createElement(PortalsManager, null, import_react21.default.createElement(FocusManager, null, children2))))))))));
  }
};
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react22.useState)(initialState);
  return {
    value,
    toggle: (0, import_react22.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react22.useCallback)(() => setState(true), []),
    setFalse: (0, import_react22.useCallback)(() => setState(false), [])
  };
}
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react23.useCallback)((event) => {
    if (disabled) {
...
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react24.useState)(false);
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react26.default.createElement("svg", {
    viewBox: "0 0 44 44",
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react26.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react26.default.createElement(import_react26.default.Fragment, null, import_react26.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react26.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react27.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react28.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react28.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react29.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react30.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react30.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react30.Children.toArray(children2).filter((child) => (0, import_react30.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react31.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react31.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react32.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react33.useRef)(null);
  const scrollToPosition = (0, import_react33.useContext)(ScrollableContext);
  ...
  return import_react33.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react34.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    return import_react34.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react34.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react34.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react35.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react35.default.createElement("div", {
      ...
      style,
      ref: this.setOverlay
    }, import_react35.default.createElement(EventListener, {
      event: "resize",
...
function Pane({
  ...
  return fixed ? import_react37.default.createElement("div", {
    style,
    className
  }, content) : import_react37.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react38.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react38.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react38.default.createElement("div", {
        id,
      ...
      return import_react38.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react38.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react38.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react38.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
      ...
      }), import_react38.default.createElement(CustomProperties, {
        colorScheme
      }, import_react38.default.createElement("div", {
        className: styles6.Wrapper
      }, content)), import_react38.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react38.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react38.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react38.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react39.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react39.useState)();
  const overlayRef = (0, import_react39.useRef)(null);
  const activatorContainer = (0, import_react39.useRef)(null);
  ...
  const setAccessibilityAttributes = (0, import_react39.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react39.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react39.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react39.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react39.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  return import_react40.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react41.createContext)(false);
...
function Pip({
  ...
  return import_react43.default.createElement("span", {
    className
  }, import_react43.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const contentMarkup = {
    function: import_react44.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react44.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react44.default.createElement("img", {
  ...
  return import_react44.default.createElement("span", {
    className
  }, import_react44.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react45.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react45.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react45.default.createElement(Pip, {
      progress,
      status,
      accessibilityLabelOverride: accessibilityLabel
    }));
  }
  return import_react45.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react45.default.createElement("span", {
    className: styles11.Icon
  }, import_react45.default.createElement(Icon, {
    source: icon
  })), children2 && import_react45.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
function useLink() {
  return (0, import_react46.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react47.memo)((0, import_react47.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react47.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react47.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react48.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react48.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react48.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react48.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react48.default.createElement("span", {
    className: styles9.Suffix
  }, import_react48.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react48.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react48.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react48.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react48.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react48.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react48.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react48.default.createElement(import_react48.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    }, import_react49.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const titleMarkup = section.title ? import_react49.default.createElement("p", {
  ...
  const sectionMarkup = import_react49.default.createElement("div", {
    className
  }, titleMarkup, import_react49.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react49.default.createElement("li", {
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react50.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react50.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react50.default.createElement(import_react50.default.Fragment, null, import_react50.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react50.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react50.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react51.default.createElement("a", commonProps, children2) : import_react51.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react51.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? import_react52.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? import_react52.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react52.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react52.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react52.default.createElement("span", {
    className: styles3.Spinner
  }, import_react52.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react52.useState)(false);
  const toggleDisclosureActive = (0, import_react52.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react52.default.createElement("button", {
      type: "button",
    ...
    connectedDisclosureMarkup = import_react52.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react52.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react52.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react52.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react52.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react53.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function ButtonGroup({
  ...
  const contents = elementChildren(children2).map((child, index) => import_react55.default.createElement(Item2, {
    button: child,
    key: index
  }));
...
// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react57.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing2,
  distribution,
...
function Heading({
  ...
  return import_react58.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react59.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react59.isValidElement)(title) ? title : import_react59.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react59.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react59.default.createElement(Stack.Item, {
    fill: true
...
function Subheading({
  ...
  return import_react60.default.createElement(Element2, {
...
function Section3({
  ...
  const actionMarkup = actions ? import_react61.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react61.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react61.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react61.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react61.default.createElement(Stack.Item, {
    fill: true
...
var Card = function Card2({
  ...
  const headerMarkup = title || actions ? import_react63.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react63.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react63.default.createElement(import_react63.default.Fragment, null, import_react63.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react63.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react63.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react63.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react63.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react63.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react63.default.createElement(WithinContentContext.Provider, {
    value: true
...
function SettingAction({
  ...
  }, children2), import_react64.default.createElement("div", {
...
function Image({
  ...
  return import_react65.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const className = classNames(styles19.Avatar, size && styles19[variationName("size", size)], !customer && styles19[variationName("style", styleClass(nameString))], hasImage && status === Status.Loaded && styles19.imageHasLoaded, shape2 && styles19[variationName("shape", shape2)]);
  const imageClassName = classNames(styles19.Image, status !== Status.Loaded && styles19.hidden);
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react66.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react66.default.createElement("path", {
    fill: "currentColor",
  ...
  const svgMarkup = hasImage ? null : import_react66.default.createElement("span", {
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react67.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react67.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react67.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react67.default.createElement("div", null, import_react67.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react67.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react67.default.createElement(Card, {
    sectioned: true
  }, import_react67.default.createElement(SettingAction, {
    action: actionElement
  }, import_react67.default.createElement(Stack, null, avatarMarkup, import_react67.default.createElement(Stack.Item, {
    fill: true
...
function RollupActions({
  ...
  const activatorMarkup = import_react68.default.createElement("div", {
    className: styles21.RollupActivator
  }, import_react68.default.createElement(Button, {
    outline: true,
  ...
  return import_react68.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react68.default.createElement(ActionList, {
    items,
    sections,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react69.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return import_react69.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react69.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const portal2 = activatorNode ? import_react70.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react70.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react70.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react71.useRef)(null);
  ...
  const buttonMarkup = import_react71.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2);
  const actionMarkup = helpText ? import_react71.default.createElement(Tooltip, {
    content: helpText
  }, buttonMarkup) : buttonMarkup;
  return import_react71.default.createElement("span", {
...
function MenuGroup({
  ...
  const handleOpen = (0, import_react72.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  ...
  const handleOffsetWidth = (0, import_react72.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react72.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  }), details && import_react72.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react73.useRef)(null);
  const menuGroupWidthRef = (0, import_react73.useRef)(0);
  const availableWidthRef = (0, import_react73.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react73.useRef)(0);
  const timesMeasured = (0, import_react73.useRef)(0);
  const actionWidthsRef = (0, import_react73.useRef)([]);
  const rollupActiveRef = (0, import_react73.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react73.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react73.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react73.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react73.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react73.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react73.useCallback)(() => {
  ...
  const measureActions = (0, import_react73.useCallback)(() => {
  ...
  const handleResize = (0, import_react73.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react73.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react73.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react73.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react73.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  ...
  }, groupedActionsMarkup, import_react73.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  }, rollup ? import_react74.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react74.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var ComboboxTextFieldContext = (0, import_react75.createContext)(void 0);
var ComboboxListboxContext = (0, import_react75.createContext)({});
var ComboboxListboxOptionContext = (0, import_react75.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react76.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react76.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react77.createContext)(void 0);
var WithinListboxContext = (0, import_react77.createContext)(false);
var ActionContext = (0, import_react77.createContext)(false);
...
function InlineError({
  ...
  }, import_react78.default.createElement(Icon, {
...
function Choice({
  ...
  const labelMarkup = import_react79.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
  ...
  }, children2), import_react79.default.createElement("span", {
    className: styles31.Label
  }, label));
  const helpTextMarkup = helpText ? import_react79.default.createElement("div", {
    className: styles31.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react79.default.createElement("div", {
    className: styles31.Error
  }, import_react79.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react79.default.createElement("div", {
    className: styles31.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react79.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react80.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react80.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react80.useState)(false);
  const isWithinListbox = (0, import_react80.useContext)(WithinListboxContext);
  ...
  return import_react80.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react80.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react80.default.createElement("span", {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react81.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react81.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react81.useContext)(ActionContext);
  ...
  }, allowMultiple && !isAction ? import_react81.default.createElement("div", {
    className: styles29.Checkbox
  }, import_react81.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react82.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react83.memo)(function LoadingOption({
  children: children2,
  ...
  return import_react83.default.createElement("li", {
    ...
    role: "presentation"
  }, children2 ? children2 : import_react83.default.createElement("div", {
    className: styles33.Loading
  }, import_react83.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react84.createContext)(null);
...
function Section4({
  ...
  return import_react85.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react85.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react85.default.createElement("ul", {
    role: "group",
...
function useSection() {
  const context = (0, import_react86.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react87.default.createElement("div", {
...
var MappedActionContext = (0, import_react88.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react89.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const isAction = (0, import_react89.useContext)(ActionContext);
  const {
    role,
    url,
    external,
    onAction,
    destructive
  } = (0, import_react89.useContext)(MappedActionContext);
  const listItemRef = (0, import_react89.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react89.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react89.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react89.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react89.default.createElement("li", Object.assign({}, sectionAttributes, {
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react90.default.createElement("div", {
    className: styles36.Icon
  }, import_react90.default.createElement(Icon, {
    color: "subdued",
    source: icon
  }));
  const className = classNames(styles36.Action, divider && styles36.ActionDivider);
  return import_react90.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react90.default.createElement(Option, props, import_react90.default.createElement("div", {
    className
  }, import_react90.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react91.useState)();
  const [activeOption, setActiveOption] = (0, import_react91.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react91.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react91.useState)([]);
  const {
  ...
  const scrollableRef = (0, import_react91.useRef)(null);
  const listboxRef = (0, import_react91.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  const getNavigableOptions = (0, import_react91.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react91.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react91.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react91.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react91.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react91.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react91.useCallback)(() => {
  ...
  (0, import_react91.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react91.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react91.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react91.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react91.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react91.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react91.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react91.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react91.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleFocus = (0, import_react91.useCallback)(() => {
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react91.default.createElement(import_react91.default.Fragment, null, import_react91.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react91.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react91.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react91.default.createElement(import_react91.default.Fragment, null, listeners, import_react91.default.createElement(VisuallyHidden, null, import_react91.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react91.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react91.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react91.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react92.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaMarkup = media ? import_react92.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react92.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react92.default.createElement(Listbox.TextOption, {
    selected,
    disabled
...
var Spinner2 = import_react93.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp
  ...
  }, import_react93.default.createElement(Icon, {
...
function Label({
  ...
  return import_react94.default.createElement("div", {
    className
  }, import_react94.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const actionMarkup = action ? import_react95.default.createElement("div", {
    className: styles40.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react95.default.createElement("div", {
    className: styles40.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react95.default.createElement("div", {
    className: styles40.Error
  }, import_react95.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react95.default.createElement("div", {
    className: styles40.LabelWrapper
  }, import_react95.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react97.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react97.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react97.default.createElement("div", {
    className: styles42.Connected
  }, leftConnectionMarkup, import_react97.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const minimumLinesNode = (0, import_react98.useRef)(null);
  const animationFrame = (0, import_react98.useRef)();
  const currentHeight = (0, import_react98.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? import_react98.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react98.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  }, import_react98.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react99.useState)(null);
  const [focus, setFocus] = (0, import_react99.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const id = useUniqueId("TextField", idProp);
  const inputRef = (0, import_react99.useRef)(null);
  const textAreaRef = (0, import_react99.useRef)(null);
  const prefixRef = (0, import_react99.useRef)(null);
  const suffixRef = (0, import_react99.useRef)(null);
  const verticalContentRef = (0, import_react99.useRef)(null);
  const buttonPressTimer = (0, import_react99.useRef)();
  const spinnerRef = (0, import_react99.useRef)(null);
  ...
  const prefixMarkup = prefix ? import_react99.default.createElement("div", {
    className: styles39.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react99.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = import_react99.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react99.default.createElement("button", {
    type: "button",
    className: styles39.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react99.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react99.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react99.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react99.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react99.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react99.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react99.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react99.default.createElement(Resizer, {
  ...
  const input = (0, import_react99.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react99.default.createElement("div", {
  ...
  const backdropMarkup = import_react99.default.createElement("div", {
  ...
  return import_react99.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react99.default.createElement(Connected, {
    left: connectedLeft,
...
function TextField2({
  ...
  const textFieldId = (0, import_react100.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react100.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react100.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react100.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react100.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react100.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react100.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react101.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react101.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react101.useState)();
  const [listboxId, setListboxId] = (0, import_react101.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react101.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react101.Children.count(children2) > 0);
  ...
  const handleOpen = (0, import_react101.useCallback)(() => {
    setPopoverActive(true);
    setActiveOptionId(void 0);
  }, []);
  const onOptionSelected = (0, import_react101.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleFocus = (0, import_react101.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleChange = (0, import_react101.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  ...
  const textFieldContextValue = (0, import_react101.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react101.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react101.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react101.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react101.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react101.Children.count(children2) > 0 ? import_react101.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react101.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react101.default.createElement(ComboboxListboxOptionContext.Provider, {
...
function MappedAction({
  ...
  if (prefix) {
    prefixMarkup = import_react102.default.createElement("div", {
      className: styles43.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react102.default.createElement("div", {
      className: styles43.Prefix
    }, import_react102.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react102.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react102.default.createElement("span", {
    className: styles43.Suffix
  }, import_react102.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react102.default.createElement("span", {
    className: styles43.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react102.default.createElement("div", {
    className: styles43.Text
  }, import_react102.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react102.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  const context = (0, import_react102.useMemo)(() => ({
    role,
    url,
    external,
    onAction,
  ...
  return import_react102.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react102.default.createElement("div", {
    className: styles43.ActionContainer
  }, import_react102.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react102.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react103.useCallback)((options2) => {
    return options2.map((option) => import_react103.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react103.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react103.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react103.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
    ...
    if (listTitle) {
      return import_react103.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react103.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react103.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react103.useCallback)((newSelection) => {
  ...
  const actionMarkup = actionBefore && import_react103.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react103.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react103.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react103.default.createElement(Listbox, {
    autoSelection,
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react104.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return import_react106.default.createElement(import_react106.default.Fragment, null, import_react106.default.createElement(ScrollLock, null), import_react106.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react107.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react108.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react109.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react109.useContext)(WithinContentContext);
  ...
  if (title) {
    ...
    headingMarkup = import_react109.default.createElement("div", {
      className: styles45.Heading,
      id: headingID
    }, import_react109.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react109.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
  ...
  }, import_react109.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react109.default.createElement("div", {
    className: styles45.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles45.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react109.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react109.default.createElement("div", {
    className: styles45.Actions
  }, import_react109.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react109.default.createElement("div", {
      className: styles45.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react109.default.createElement("div", {
    className: styles45.Dismiss
  }, import_react109.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react109.default.createElement(BannerContext.Provider, {
    value: true
  ...
  }, dismissButton, import_react109.default.createElement("div", {
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react109.default.createElement(UnstyledLink, {
  ...
  return import_react109.default.createElement(UnstyledButton, {
    className: styles45.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  ...
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react109.useState)(false);
  (0, import_react109.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement("span", {
    className: styles46.Icon
  }, import_react110.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react110.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react110.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles46.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react110.default.createElement("button", {
    key: content,
    className: styles46.Breadcrumb,
  ...
  return import_react110.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react112.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react112.default.cloneElement(import_react112.default.Children.only(children2), childProps));
  };
  return Transition2;
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react113.default.createElement(Transition_default, _extends({}, props, {
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react114.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react114.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react114.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react114.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react114.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react114.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react114.isValidElement)(prevChild)) {
      children2[key] = (0, import_react114.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react115.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react115.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react115.default.createElement(Component9, props, children2));
  };
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react116.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react116.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react116.default.createElement(TransitionGroup_default, props, inProp ? import_react116.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react116.default.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react116.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react117.default.isValidElement(oldChildren) && import_react117.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react117.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react117.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react117.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react117.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react117.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react117.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react117.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react118.useRef)(false);
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react120.useRef)(null);
  ...
  return import_react120.default.createElement("div", {
    ...
    disabled,
    disclosure
  }, content), indicator && import_react120.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react121.default.createElement(import_react121.default.Fragment, null, import_react121.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react121.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, import_react121.default.createElement(ActionList, {
    items: actions,
...
var ResourceListContext = (0, import_react122.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react123.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react123.useContext)(ResourceListContext);
  ...
  return import_react123.default.createElement("div", {
  ...
  }, import_react123.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
    ...
    ref: checkBoxRef
  })), import_react123.default.createElement("span", {
...
var BulkActionsInner = class extends import_react124.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react124.createRef)();
    this.largeScreenGroupNode = (0, import_react124.createRef)();
    this.smallScreenGroupNode = (0, import_react124.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react124.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react124.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react124.default.createElement("div", {
      className: styles47.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react124.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react124.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react124.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react124.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    }, import_react124.default.createElement(ActionList, {
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react124.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react124.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react124.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react124.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react124.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      ...
      }, import_react124.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react124.default.createElement(CSSTransition_default, {
      ...
      }, import_react124.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react124.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react124.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react124.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react124.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      ...
      }, import_react124.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react124.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function TextContainer({
  ...
  const className = classNames(styles51.TextContainer, spacing2 && styles51[variationName("spacing", spacing2)]);
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react126.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react126.default.createElement("div", {
  ...
  return import_react126.default.createElement(Card, null, import_react126.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react126.default.createElement(Card.Section, null, import_react126.default.createElement("div", {
  ...
  }, import_react126.default.createElement(Heading, null, title)), import_react126.default.createElement(TextContainer, null, children2), import_react126.default.createElement("div", {
    className: styles50.Buttons
  }, buttonMarkup)), import_react126.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react127.default.createElement("p", {
...
function RadioButton({
  ...
  const inputNode = (0, import_react128.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react128.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  return import_react128.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
...
function ChoiceList({
  ...
  const titleMarkup = title ? import_react129.default.createElement("legend", {
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react129.default.createElement("div", {
      className: styles53.ChoiceChildren
    }, renderedChildren) : null;
    return import_react129.default.createElement("li", {
      key: value,
      className: styles53.ChoiceItem
    }, import_react129.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && import_react129.default.createElement("div", {
    className: styles53.ChoiceError
  }, import_react129.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react129.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react129.default.createElement("ul", {
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react130.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react130.useState)(open);
  const [animationState, setAnimationState] = (0, import_react130.useState)("idle");
  const collapsibleContainer = (0, import_react130.useRef)(null);
  ...
  const handleCompleteAnimation = (0, import_react130.useCallback)(({
    target
  }) => {
...
var Slidable = class extends import_react131.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react131.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react131.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react131.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react131.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react131.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    ...
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react131.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react132.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react133.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
...
var ColorPicker = class extends import_react134.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react134.default.createElement(AlphaPicker, {
      alpha,
      color,
    ...
    }, import_react134.default.createElement("div", {
    ...
    }), import_react134.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react134.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react134.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var FrameContext = (0, import_react135.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react136.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react137.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function Cell({
  ...
  const className = classNames(styles57.Cell, styles57[`Cell-${variationName("verticalAlign", verticalAlign)}`], firstColumn && styles57["Cell-firstColumn"], firstColumn && truncate && styles57["Cell-truncated"], header && styles57["Cell-header"], total && styles57["Cell-total"], totalInFooter && styles57["Cell-total-footer"], numeric && styles57["Cell-numeric"], sortable && styles57["Cell-sortable"], sorted && styles57["Cell-sorted"], stickyHeadingCell && styles57.StickyHeaderCell, hovered && styles57["Cell-hovered"], fixedCellVisible && styles57.separate, firstColumn && inFixedFirstColumn && stickyHeadingCell && styles57.FixedFirstColumn);
  ...
  const iconMarkup = import_react138.default.createElement("span", {
    className: iconClassName
  }, import_react138.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const focusable = !(stickyHeadingCell && hasFixedFirstColumn && firstColumn && !inFixedFirstColumn);
  const sortableHeadingContent = import_react138.default.createElement("button", {
  ...
  const stickyHeading = import_react138.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react138.default.createElement("th", Object.assign({}, headerCell.props, colSpanProp, {
    ref: setRef,
    className,
    scope: "col",
    "aria-sort": sortDirection,
  ...
  }), columnHeadingContent) : import_react138.default.createElement("th", Object.assign({
    style: {
      minWidth: firstColumnMinWidth
    },
    className,
  ...
  }), import_react138.default.createElement(TruncatedText, {
    className: styles57.TooltipContent
  }, content));
  const cellMarkup = header || firstColumn ? headingMarkup : import_react138.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react138.useRef)(null);
  const {
    current
  } = textRef;
  const text = import_react138.default.createElement("span", {
    ref: textRef,
    className
  }, children2);
  return (current === null || current === void 0 ? void 0 : current.scrollWidth) > (current === null || current === void 0 ? void 0 : current.offsetWidth) ? import_react138.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return import_react139.default.createElement(import_react139.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react140.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react141.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react141.default.createElement("div", null, import_react141.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react141.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  return import_react142.default.createElement("div", {
    ...
    ref: setRef
  }, import_react142.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react142.default.createElement(Button, {
    plain: true,
...
var DataTableInner = class extends import_react143.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react143.createRef)();
    this.scrollContainer = (0, import_react143.createRef)();
    this.table = (0, import_react143.createRef)();
    this.stickyTable = (0, import_react143.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedFirstColumn && inStickyHeader) {
        return [import_react143.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), import_react143.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = (total, index) => {
      ...
      return import_react143.default.createElement(Cell, {
        total: true,
        totalInFooter,
        firstColumn: index === 0,
        key: id,
    ...
    this.defaultRenderRow = ({
      ...
      return import_react143.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = import_react143.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedFirstColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react143.default.createElement("tr", null, totals.map(this.renderTotals)) : null;
    ...
    const fixedFirstColumnMarkup = condensed && fixedFirstColumn && import_react143.default.createElement("table", {
    ...
    }, import_react143.default.createElement("thead", null, import_react143.default.createElement("tr", {
      style: {
      ...
      inFixedFirstColumn: true,
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react143.default.createElement("tr", {
      style: {
        height: `${headerRowHeights[1]}px`
      }
    }, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))), import_react143.default.createElement("tbody", null, firstColumn.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && import_react143.default.createElement("tfoot", null, import_react143.default.createElement("tr", null, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))));
    const bodyMarkup = rows.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: false
    }));
    const footerMarkup = footerContent ? import_react143.default.createElement("div", {
      className: styles57.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react143.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : import_react143.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react143.default.createElement(AfterInitialMount, null, import_react143.default.createElement("div", {
      className: styles57.StickyHeaderWrapper,
      role: "presentation"
    }, import_react143.default.createElement(Sticky, {
      ...
      }, import_react143.default.createElement("div", null, navigationMarkup("sticky")), import_react143.default.createElement("table", {
    ...
    return import_react143.default.createElement("div", {
      className: wrapperClassName,
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), import_react143.default.createElement("div", {
      className
    }, import_react143.default.createElement("div", {
      className: styles57.ScrollContainer,
      ref: this.scrollContainer
    }, import_react143.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react143.default.createElement(EventListener, {
      capture: true,
    ...
    }), fixedFirstColumnMarkup, import_react143.default.createElement("table", {
      className: styles57.Table,
      ref: this.table
    }, import_react143.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react143.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
};
function DataTable(props) {
  const i18n = useI18n();
  return import_react143.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react144.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles58.Weekday, current && styles58["Weekday-current"]);
  return import_react144.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react145.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react145.useRef)(null);
  ...
  if (!day) {
    return import_react145.default.createElement("td", {
  ...
  }, import_react145.default.createElement("button", {
    onFocus: () => onFocus(day),
    type: "button",
    ref: dayNode,
    tabIndex,
...
function Month({
  ...
  const weeks = (0, import_react146.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react146.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react146.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react146.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react146.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react146.default.createElement("tr", {
    className: styles58.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react146.default.createElement("div", {
    className: styles58.MonthContainer
  }, import_react146.default.createElement("table", {
    role: "grid",
    className: styles58.Month
  }, import_react146.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react146.default.createElement("thead", null, import_react146.default.createElement("tr", {
    className: styles58.WeekHeadings
  }, weekdays)), import_react146.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react147.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react147.useState)(void 0);
  (0, import_react147.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react147.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react147.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react147.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react147.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react147.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react147.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react147.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react147.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  }, import_react147.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react148.default.createElement("dt", {
    key: `dt${index}`,
    className: styles59.Term
  }, term), import_react148.default.createElement("dd", {
    key: `dd${index}`,
    className: styles59.Description
  }, description)], []);
  const className = classNames(styles59.DescriptionList, spacing2 === "tight" && styles59.spacingTight);
  return import_react148.default.createElement("dl", {
    className
  }, terms);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react150.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react151.useContext)(DropZoneContext);
  ...
  const actionMarkup = import_react151.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  ...
  const actionHintMarkup = actionHint && import_react151.default.createElement(Caption, null, import_react151.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react151.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react151.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react152.useRef)(null);
  const dragTargets = (0, import_react152.useRef)([]);
  const adjustSize = (0, import_react152.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react152.useState)(false);
  const [internalError, setInternalError] = (0, import_react152.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react152.useState)("large");
  const [measuring, setMeasuring] = (0, import_react152.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react152.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react152.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react152.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react152.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react152.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const context = (0, import_react152.useMemo)(() => ({
    disabled,
    focused,
    size,
    type: type || "file",
  ...
  return import_react152.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react152.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react152.default.createElement(VisuallyHidden, null, import_react152.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react152.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    ...
    }, import_react152.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react152.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react152.default.createElement(Caption, null, import_react152.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react152.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react152.createRef)();
  ...
  render() {
    ...
    return import_react152.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react153.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react153.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react153.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react153.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react153.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react154.useContext)(WithinContentContext);
  ...
  const imageMarkup = largeImage ? import_react154.default.createElement(Image, {
    alt: "",
    role: "presentation",
  ...
  }) : import_react154.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles63.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react154.default.createElement("div", {
    className: styles63.FooterContent
  }, import_react154.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react154.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react154.default.createElement("div", {
    className: styles63.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react154.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react154.default.createElement("div", {
    className: styles63.Actions
  }, import_react154.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, secondaryActionMarkup, primaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react154.default.createElement("div", {
    className: styles63.DetailsContainer
  }, import_react154.default.createElement("div", {
    className: styles63.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react154.default.createElement("div", {
    className: styles63.DetailsContainer
  });
  ...
  }, detailsMarkup, import_react154.default.createElement("div", {
...
function Truncate({
  ...
  return import_react155.default.createElement("span", {
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const iconMarkup = icon ? import_react156.default.createElement(Icon, {
      source: icon
    }) : import_react156.default.createElement("span", {
      className: styles64.Bullet
    });
    const titleMarkup = title && import_react156.default.createElement("span", {
      className: styles64.Title
    }, title);
    const descriptionMarkup = description && import_react156.default.createElement("span", {
      className: styles64.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react156.Fragment;
    return import_react156.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react156.default.createElement("span", {
      className: styles64.Icon
    }, iconMarkup), import_react156.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react156.default.createElement("ul", {
...
var ConnectedFilterControl = class extends import_react158.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react158.createRef)();
    this.proxyButtonContainer = (0, import_react158.createRef)();
    this.moreFiltersButtonContainer = (0, import_react158.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const rightMarkup = actionsToRender.length > 0 ? import_react158.default.createElement("div", {
    ...
    const rightActionMarkup = rightAction ? import_react158.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react158.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react158.default.createElement("div", {
      className: styles67.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react158.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react158.default.createElement("div", {
      className: styles67.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react158.default.createElement(import_react158.default.Fragment, null, proxyButtonMarkup, import_react158.default.createElement("div", {
      className: styles67.Wrapper
    }, import_react158.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react158.default.createElement("div", {
      className: styles67.CenterContainer
    }, import_react158.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react158.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react158.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react158.default.createElement(Item5, {
        key: action.key
      }, import_react158.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react159.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react159.default.createElement(import_react159.default.Fragment, null, children2);
}
...
function Tag({
  ...
  if (onClick) {
    return import_react160.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react160.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
  ...
  const tagContent = url && !disabled ? import_react160.default.createElement("a", {
    className: classNames(styles68.Link, segmented && styles68.segmented),
    href: url
  }, import_react160.default.createElement("span", {
    title: tagTitle,
    className: styles68.LinkText
  }, children2)) : import_react160.default.createElement("span", {
    title: tagTitle,
...
function useMediaQuery() {
  const mediaQuery = (0, import_react161.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react162.useContext)(FocusManagerContext);
...
var Focus = (0, import_react163.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  ...
  return import_react163.default.createElement(import_react163.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react164.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react164.useState)(true);
  ...
  return import_react164.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react164.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react164.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react164.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
function Sheet({
  ...
  const container = (0, import_react165.useRef)(null);
  const activatorRef = (0, import_react165.useRef)(null);
  const handleClose = (0, import_react165.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react165.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react165.default.createElement(import_react165.default.Fragment, null, activatorMarkup, import_react165.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react165.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    ref: container
  }), import_react165.default.createElement(TrapFocus, {
    trapping: open
    ...
    "aria-label": accessibilityLabel
  }, children2)))), import_react165.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react165.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react166.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react166.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react166.createRef)();
    this.focusNode = (0, import_react166.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react166.default.createElement(import_react166.default.Fragment, null, import_react166.default.createElement(ScrollLock, null), import_react166.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react166.default.createElement("div", {
        className: styles66.AppliedFilterBadgeContainer
      }, import_react166.default.createElement(Badge, {
        size: "small",
        status: "new"
      ...
      }, import_react166.default.createElement("h3", {
        className: styles66.FilterTriggerTitle
      }, import_react166.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react166.default.createElement("span", {
        className: styles66.FilterTriggerIcon
      }, import_react166.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react166.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react166.default.createElement("div", {
        className: styles66.FilterNodeContainer
      }, import_react166.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react166.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react166.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react166.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react166.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react166.default.createElement("span", {
    ...
    const filtersDesktopHeaderMarkup = import_react166.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react166.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react166.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react166.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react166.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterMarkup = import_react166.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react166.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react166.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react166.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react166.default.createElement("div", {
      className: styles66.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react166.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react166.default.createElement("div", {
      ...
      variation: "subdued"
    }, import_react166.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react166.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react166.default.createElement("div", {
      className: styles66.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react166.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? import_react166.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react166.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react166.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
    ...
    }, filtersDesktopHeaderMarkup, import_react166.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react166.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles66.HelpText
    }, import_react166.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react166.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react166.default.createElement("div", {
      className: styles66.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react166.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react166.default.createElement(Button, {
      plain: true,
    ...
    return import_react166.default.createElement("div", {
      ref: this.focusNode
    }, import_react166.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
...
function Filters(props) {
  ...
  return import_react166.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react168.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react168.default.createElement(VisuallyHidden, null, import_react168.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react168.default.createElement("form", {
    acceptCharset,
    action,
...
function Item6({
  ...
  return children2 ? import_react169.default.createElement("div", {
...
function Group({
  ...
  if (helpText) {
    ...
    helpTextElement = import_react170.default.createElement("div", {
      id: helpTextID3,
  ...
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react170.default.createElement("div", {
      id: titleID,
      className: styles71.Title
    }, title);
  }
  const itemsMarkup = import_react170.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
...
// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react171.memo)(function FormLayout2({
  children: children2
}) {
  return import_react171.default.createElement("div", {
    className: styles71.FormLayout
  }, import_react171.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react172.useRef)(false);
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react173.useState)(0);
  const [animating, setAnimating] = (0, import_react173.useState)(false);
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react174.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react174.useRef)(false);
  const node = (0, import_react174.useRef)(null);
...
function Dialog({
  ...
  const containerNode = (0, import_react175.useRef)(null);
  ...
  return import_react175.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react175.default.createElement(TrapFocus, null, import_react175.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react175.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
...
function FadeUp({
  ...
  return import_react175.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function Header3({
  ...
  }, import_react177.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react177.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  return import_react178.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react179.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  ...
  }, import_react179.default.createElement(Stack, {
    alignment: "center"
  }, import_react179.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react180.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react180.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react180.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react180.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react180.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react180.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react180.default.createElement("div", {
      className: styles76.Spinner
    }, import_react180.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react180.default.createElement("div", {
      className: styles76.Body
    }, body) : import_react180.default.createElement(Scrollable, {
      shadow: true,
      className: styles76.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react180.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react180.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react180.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react180.default.createElement("div", {
      className: styles76.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop = import_react180.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react180.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react180.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react180.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react180.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react181.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react182.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react182.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react182.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react182.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react182.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react182.default.createElement("div", {
    className: styles75.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react182.default.createElement("div", {
    className: styles75.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles75.Contents, fullWidth && styles75.fullWidth);
  return import_react182.default.createElement(import_react182.default.Fragment, null, import_react182.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react182.default.createElement("div", {
    className: styles75.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react182.default.createElement("div", {
    className: contentsClassName
  }, import_react182.default.createElement("h2", {
    className: styles75.Message
  }, message), import_react182.default.createElement("div", {
    className: styles75.ActionContainer
  }, import_react182.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react183.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react184.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react185.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react186.default.createElement("button", {
    type: "button",
  ...
  const actionMarkup = action ? import_react186.default.createElement("div", {
    className: styles83.Action
  }, import_react186.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  const className = classNames(styles83.Toast, error && styles83.error);
  return import_react186.default.createElement(CustomProperties, {
    colorScheme: "dark"
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react187.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react187.createRef)();
    toastNodes[index] = toastNode;
    return import_react187.default.createElement(CSSTransition_default, {
      ...
      ref: toastNode
    }, import_react187.default.createElement(Toast, toast)));
  });
  return import_react187.default.createElement(Portal, null, import_react187.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react187.default.createElement("div", {
    className: styles82.ToastManager,
    "aria-live": "assertive"
  }, import_react187.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
...
var FrameInner = class extends import_react188.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react188.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react188.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react188.default.createElement(CSSTransition_default, {
    ...
    }, import_react188.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react188.default.createElement("button", {
      type: "button",
    ...
    const loadingMarkup = loadingStack > 0 ? import_react188.default.createElement("div", {
      className: styles72.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react188.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react188.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles72.ContextualSaveBar,
      type: "fade"
    }, import_react188.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react188.default.createElement("div", Object.assign({
      className: styles72.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react188.default.createElement("div", {
    ...
    const skipMarkup = import_react188.default.createElement("div", {
      className: skipClassName
    }, import_react188.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react188.default.createElement(Backdrop, {
    ...
    return import_react188.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react188.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react188.default.createElement("main", {
      className: styles72.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react188.default.createElement("div", {
      className: styles72.Content
    }, children2)), import_react188.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react188.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react188.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
var IndexContext = (0, import_react192.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react192.createContext)(void 0);
var IndexRowContext = (0, import_react192.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react193.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react193.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react193.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react193.useRef)(null);
  const handleSelectionChange = (0, import_react193.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react194.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react194.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react194.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react194.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react194.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react195.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles87.TableCell, flush && styles87["TableCell-flush"]);
  return import_react195.default.createElement("td", {
...
var RowContext = (0, import_react196.createContext)({});
var RowHoveredContext = (0, import_react196.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react196.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react197.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react197.useContext)(RowContext);
  const wrapperClassName = classNames(styles88.Wrapper, condensed ? styles88.condensed : styles88.expanded);
  const Wrapper = condensed ? import_react197.Fragment : CheckboxWrapper;
  return import_react197.default.createElement(Wrapper, null, import_react197.default.createElement("div", {
    className: styles88.TableCellContentContainer
  }, import_react197.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop10
  }, import_react197.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react197.useRef)(null);
  const handleResize = (0, import_react197.useCallback)(() => {
  ...
  return import_react197.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react198.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react198.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react198.useMemo)(() => ({
    itemId: id,
    selected,
    onInteraction: handleInteraction,
    disabled
  }), [id, selected, disabled, handleInteraction]);
  const primaryLinkElement = (0, import_react198.useRef)(null);
  const isNavigating = (0, import_react198.useRef)(false);
  const tableRowRef = (0, import_react198.useRef)(null);
  const tableRowCallbackRef = (0, import_react198.useCallback)((node) => {
  ...
  const checkboxMarkup = selectable ? import_react198.default.createElement(Checkbox3, null) : null;
  return import_react198.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react198.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react198.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  const [containerScroll, setContainerScroll] = (0, import_react199.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react199.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react199.default.createElement(ScrollContext.Provider, {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react200.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react200.useRef)([]);
  const scrollableContainerElement = (0, import_react200.useRef)(null);
  const tableElement = (0, import_react200.useRef)(null);
  const condensedListElement = (0, import_react200.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react200.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react200.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react200.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react200.useState)(false);
  const [smallScreen, setSmallScreen] = (0, import_react200.useState)(isSmallScreen());
  const tableHeadings = (0, import_react200.useRef)([]);
  const stickyTableHeadings = (0, import_react200.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react200.useRef)(null);
  const firstStickyHeaderElement = (0, import_react200.useRef)(null);
  const stickyHeaderElement = (0, import_react200.useRef)(null);
  const scrollBarElement = (0, import_react200.useRef)(null);
  const scrollContainerElement = (0, import_react200.useRef)(null);
  const scrollingWithBar = (0, import_react200.useRef)(false);
  const scrollingContainer = (0, import_react200.useRef)(false);
  const tableBodyRef = (0, import_react200.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react200.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react200.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react200.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react200.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react200.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react200.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react200.useState)(true);
  const handleCanScrollRight = (0, import_react200.useCallback)(() => {
  ...
  const handleIsSmallScreen = (0, import_react200.useCallback)(() => {
    setSmallScreen(smallScreen);
  }, [smallScreen]);
  const handleResize = (0, import_react200.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react200.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react200.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react200.default.createElement("div", {
    className: styles87.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react200.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react200.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react200.default.createElement("div", {
    className: styles87["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0], 0)), !selectable && import_react200.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0], 0))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react200.useCallback)(() => {
  ...
  const loadingMarkup = import_react200.default.createElement(CSSTransition_default, {
    in: loading,
  ...
  }, import_react200.default.createElement(Spinner, {
    size: "small"
  ...
  const stickyHeaderMarkup = import_react200.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react200.default.createElement(Sticky, {
    ...
    const bulkActionsMarkup = shouldShowBulkActions ? import_react200.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react200.default.createElement(BulkActions, {
      smallScreen,
    ...
    const selectButtonMarkup = import_react200.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react200.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, !selectable && styles87.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react200.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react200.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react200.default.createElement("div", {
  ...
  const scrollBarMarkup = itemCount > 0 ? import_react200.default.createElement(AfterInitialMount, null, import_react200.default.createElement("div", {
  ...
  const emptyStateMarkup = emptyState ? emptyState : import_react200.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react200.default.createElement(import_react200.default.Fragment, null, import_react200.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react200.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react200.default.createElement(import_react200.default.Fragment, null, sharedMarkup, import_react200.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles87.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react200.default.createElement(import_react200.default.Fragment, null, sharedMarkup, import_react200.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react200.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react200.default.createElement("thead", null, import_react200.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react200.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react200.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react200.default.createElement(import_react200.default.Fragment, null, import_react200.default.createElement("div", {
  ...
  function renderHeading(heading, index) {
    ...
    const headingContent = import_react200.default.createElement("th", {
    ...
    const checkboxContent = import_react200.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    ...
    }, import_react200.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react200.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react200.default.createElement("span", null, heading.title), import_react200.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react200.default.createElement(VisuallyHidden, null, heading.title);
    } else {
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      const iconMarkup = import_react200.default.createElement("span", {
      ...
      return import_react200.default.createElement(UnstyledButton, {
...
function IndexTable({
  ...
  return import_react200.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react200.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
...
var Navigation2 = function Navigation3({
  ...
  const logoMarkup = logo ? import_react215.default.createElement("div", {
    className: classNames(styles95.LogoContainer, logoSuffix && styles95.hasLogoSuffix)
...
function PolarisTestProvider({
  ...
  return import_react226.default.createElement(Wrapper, null, import_react226.default.createElement(FeaturesContext.Provider, {
    ...
    value: link
  }, import_react226.default.createElement(CustomProperties, {
    colorScheme
...
var ResourceList = function ResourceList2({
  ...
  const [smallScreen, setSmallScreen] = (0, import_react234.useState)(isSmallScreen2());
...
function Thumbnail({
  ...
  const content = typeof source === "string" ? import_react247.default.createElement(Image, {
    alt,
    source
  ...
  return import_react247.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react248.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const handleDismiss = (0, import_react249.useCallback)(({
    target
  }) => {
  ...
  return import_react249.default.createElement(import_react249.default.Fragment, null, visible ? import_react249.default.createElement(ScrollLock, null) : null, import_react249.default.createElement("div", {
    ref: node,
...
function Search({
  ...
  const overlayMarkup = visible ? import_react250.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react250.default.createElement(import_react250.default.Fragment, null, overlayMarkup, import_react250.default.createElement("div", {
    className: classNames(styles117.Search, visible && styles117.visible)
  }, import_react250.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react250.default.createElement("div", {
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react251.useState)(false);
  const input = (0, import_react251.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react251.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react251.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react251.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react251.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react251.default.createElement("button", {
    type: "button",
  ...
  return import_react251.default.createElement("div", {
    ...
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react251.default.createElement(VisuallyHidden, null, import_react251.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react251.default.createElement("input", {
    id: searchId,
    ...
    source: SvgSearchMinor
  })), clearMarkup, import_react251.default.createElement("div", {
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react252.default.createElement("div", {
...
function Message({
  ...
  const badgeMarkup = badge && import_react253.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  }, import_react253.default.createElement(Popover2.Section, null, import_react253.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react253.default.createElement(TextContainer, null, import_react253.default.createElement(Heading, null, title, badgeMarkup), import_react253.default.createElement("p", null, description)), import_react253.default.createElement(Link, {
    url: to
  }, linkContent), import_react253.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react254.default.createElement(Message, {
    title: message.title,
  ...
  return import_react254.default.createElement(Popover2, {
    activator: import_react254.default.createElement("div", {
      className: styles122.ActivatorWrapper
    }, import_react254.default.createElement("button", {
      type: "button",
    ...
    preferredAlignment: "right",
    colorScheme
  }, import_react254.default.createElement(ActionList, {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react255.default.createElement(import_react255.default.Fragment, null, import_react255.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react255.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react255.default.createElement("span", {
    className: styles120.Details
  }, import_react255.default.createElement("p", {
    className: styles120.Name
  }, name), import_react255.default.createElement("p", {
  ...
  return import_react255.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const navigationButtonMarkup = showNavigationToggle ? import_react256.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react256.default.createElement("div", {
    ...
    contextMarkup = import_react256.default.createElement("div", {
      className
    }, import_react256.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles116.LogoLink,
      style: {
        width
      }
    }, import_react256.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
  ...
  const searchMarkup = searchField ? import_react256.default.createElement(import_react256.default.Fragment, null, searchField, import_react256.default.createElement(Search, {
  ...
  }, navigationButtonMarkup, contextMarkup, import_react256.default.createElement("div", {
    className: styles116.Contents
  }, import_react256.default.createElement("div", {
    className: styles116.SearchField
  }, searchMarkup), import_react256.default.createElement("div", {
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react257.default.createElement("p", {
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react257.default.createElement("div", {
      className: styles124.Progress
    }, import_react257.default.createElement("progress", {
    ...
    }, import_react257.default.createElement("span", {
  ...
  }, import_react257.default.createElement("button", {
    type: "button",
  ...
  }, import_react257.default.createElement("img", {
...
function useRowHovered() {
  const hovered = (0, import_react258.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react258.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react258.useContext)(ScrollContext);
