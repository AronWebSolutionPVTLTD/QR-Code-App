...
export declare type ListAction<Item> = ReinitializeAction<Item> | AddFieldItemAction<Item> | MoveFieldItemAction | RemoveFieldItemAction | RemoveFieldItemsAction | UpdateErrorAction<Item> | UpdateAction<Item, keyof Item> | ResetAction<Item, keyof Item> | NewDefaultAction<Item, keyof Item> | ResetListAction;
...
export declare function resetListAction(): ResetListAction;
